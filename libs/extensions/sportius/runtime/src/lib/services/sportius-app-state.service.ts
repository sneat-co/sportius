...
export interface ISportiusAppState {
  collapsedGroups: string[];
  showWatched: boolean;
}

export abstract class ISportiusAppStateService extends LocalAppState<ISportiusAppState> {
...
@Injectable()
export class SportiusAppStateService extends ISportiusAppStateService {
  constructor() {
  ...
  public setShowWatched(showWatched: boolean): void {
    const appState: ISportiusAppState = {
      ...this.getAppState(),
      showWatched,
    };
    this.saveAppState(appState);
